         ...
         <div className="page">
            ...
            <div className="text-zone">
               ...
               <div className="myCv">
                  ...
                  <div className='okay'><a href="https://drive.google.com/file/d/1EHKF7YBCRGSU_DtnnjJwpK5zYPY45ql7/view?usp=sharing" target="__blank">CLICK HERE TO VIEW PDF</a></div>
               </div>
            </div>
